...
class girl_pregnant_w5 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.girl_pregnant_w5)
        ...
        previousbutton.setOnClickListener {
            val intent = Intent(this, girl_pregnant_w4::class.java)
            startActivity(intent)
        }

        nextbutton.setOnClickListener {
            val intent = Intent(this, girl_pregnant_w5::class.java)
            startActivity(intent)
        }
    }
}