...
class girl_pregnant_w11 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.girl_pregnant_w11)
        ...
        previousbutton.setOnClickListener {
            val intent = Intent(this, girl_pregnant_w10::class.java)
            startActivity(intent)
        }

        nextbutton.setOnClickListener {
            val intent = Intent(this, girl_pregnant_w12::class.java)
            startActivity(intent)
        }
    }
}