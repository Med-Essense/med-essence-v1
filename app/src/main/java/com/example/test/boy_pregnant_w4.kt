...
class boy_pregnant_w4 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.boy_pregnant_w4)
        ...
        previousbutton.setOnClickListener {
            val intent = Intent(this, boy_pregnant_w3::class.java)
            startActivity(intent)
        }

        nextbutton.setOnClickListener {
            val intent = Intent(this, boy_pregnant_w5::class.java)
            startActivity(intent)
        }
    }
}