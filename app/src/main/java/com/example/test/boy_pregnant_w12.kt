...
class boy_pregnant_w12 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.boy_pregnant_w12)
        ...
        previousbutton.setOnClickListener {
            val intent = Intent(this, boy_pregnant_w11::class.java)
            startActivity(intent)
        }

        nextbutton.setOnClickListener {
            val intent = Intent(this, boy_pregnant_w16::class.java)
            startActivity(intent)
        }
    }
}