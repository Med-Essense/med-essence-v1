...
class boy_pregnant_w24 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.boy_pregnant_w24)
        ...
        previousbutton.setOnClickListener {
            val intent = Intent(this, boy_pregnant_w20::class.java)
            startActivity(intent)
        }

        nextbutton.setOnClickListener {
            val intent = Intent(this, boy_pregnant_w28::class.java)
            startActivity(intent)
        }
    }
}