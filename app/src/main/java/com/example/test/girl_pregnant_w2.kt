...
class girl_pregnant_w2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.girl_pregnant_w2)
        ...
        previousbutton.setOnClickListener {
            val intent = Intent(this, girl_pregnant_w1::class.java)
            startActivity(intent)
        }

        nextbutton.setOnClickListener {
            val intent = Intent(this, girl_pregnant_w3::class.java)
            startActivity(intent)
        }
    }
}