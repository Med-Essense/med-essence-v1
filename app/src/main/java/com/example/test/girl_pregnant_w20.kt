...
class girl_pregnant_w20 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.girl_pregnant_w20)
        ...
        previousbutton.setOnClickListener {
            val intent = Intent(this, girl_pregnant_w16::class.java)
            startActivity(intent)
        }

        nextbutton.setOnClickListener {
            val intent = Intent(this, girl_pregnant_w24::class.java)
            startActivity(intent)
        }
    }
}